...
addMarkers(lng = all_cities$longitude, lat = all_cities$latitude, popup = paste("<b>Price :</b>", all_cities$price,"   CHF","<br/>", "<b>Adress :</b>", all_cities$address,"<br/>",
                                                                  "<b>Number of rooms :</b>", all_cities$rooms,"<br/>",
                                                                  "<b>Size :</b>", all_cities$m2, " m2"))
```

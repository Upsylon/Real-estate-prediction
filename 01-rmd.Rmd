...
=======
>>>>>>> 23fd0975363da86d3e2d9dd68a7333db195e4ff1
...
<<<<<<< HEAD
  addMarkers(lng=6.631378, lat=46.51382, popup="The birthplace of R")
...
=======
  ...
  addPopups(
    6.6322734, 46.5196535, popup = cities[4],
    options = popupOptions(closeButton = T)
  ) # %>%
  # addPopups(
  #   8.539183, 47.368650, popup = "Zurich",
  #   options = popupOptions(closeButton = T) 
  # )
  #etc. 
```

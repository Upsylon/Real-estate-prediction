...
The objectives of our project is to create an interactive map of the Swiss real estate market. The map is represented as a Shiny App. To have all the informations we have created our "swissimmo" package. The package is composed of different functions that helps users to get his data. All the data available on the App has been web scraped on Immoscout24. \
